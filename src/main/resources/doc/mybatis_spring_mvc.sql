...
INSERT INTO `sys_user` VALUES ('798061257532551168', 'xx', '43', null);
...
CREATE TABLE `user` (
  `user_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'User Id',
  `user_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'User Code',
  `user_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'User Name',
  `salary` double DEFAULT NULL COMMENT 'Salary',
  `sex` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Sex',
  `degree` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Degree',
  ...
  `string_date` varchar(10) DEFAULT NULL COMMENT 'Date String',
  `string_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Time String',
  PRIMARY KEY (`user_id`)
