...
<!-- font-awesome -->
<link rel="stylesheet" type="text/css"
	href="resources/fontAwesome/css/font-awesome.min.css" media="all" />
<!-- DLShouWen Grid -->
<script type="text/javascript"
	src="resources/dlshouwen/js/dlshouwen.grid.js"></script>
<script type="text/javascript" src="resources/dlshouwen/i18n/zh-cn.js"></script>
<link rel="stylesheet" type="text/css"
	href="resources/dlshouwen/css/dlshouwen.grid.css" />
<!-- datePicker -->
<script type="text/javascript" src="resources/datePicker/WdatePicker.js"
	defer="defer"></script>
<link rel="stylesheet" type="text/css"
	href="resources/datePicker/skin/WdatePicker.css" />
<link rel="stylesheet" type="text/css"
	href="resources/datePicker/skin/default/datepicker.css" />

<!-- toTop -->
<script type="text/javascript" src="resources/toTop/jquery.toTop.js"></script>
<link rel="stylesheet" type="text/css"
	href="resources/toTop/jquery.toTop.css" />

<!-- syntaxHighLighter -->
<script type="text/javascript"
	src="resources/syntaxHighLighter/scripts/shCore.js"></script>
<script type="text/javascript"
	src="resources/syntaxHighLighter/scripts/shBrushBash.js"></script>
<script type="text/javascript"
	src="resources/syntaxHighLighter/scripts/shBrushXml.js"></script>
<script type="text/javascript"
	src="resources/syntaxHighLighter/scripts/shBrushJScript.js"></script>
<link rel="stylesheet" type="text/css"
	href="resources/syntaxHighLighter/styles/shCore.css" />
<link rel="stylesheet" type="text/css"
	href="resources/syntaxHighLighter/styles/shThemeDefault.css" />
...
<script type="text/javascript">
	...
	for (var i = 0; i < 186; i++) {
		...
		user.user_name = '模拟用户' + (Math.floor(Math.random() * 1000) + 10000)
				+ '号';
		user.sex = (Math.floor(Math.random() * 2) + 1);
		user.salary = (Math.floor(Math.random() * 6000) + 6000);
		user.degree = (Math.floor(Math.random() * 8) + 1);
		user.time = new Date(
				Math.floor(Math.random() * 1096588800000) + 315504000000);
		user.time_stamp_s = Math.floor((Math
				.floor(Math.random() * 1096588800000) + 315504000000) / 1000);
		user.time_stamp_ms = Math.floor(Math.random() * 1096588800000) + 315504000000;
		user.string_date = $.fn.dlshouwen.grid.tools.dateFormat(new Date(Math
				.floor(Math.random() * 1096588800000) + 315504000000),
				'yyyy-MM-dd');
		user.string_time = $.fn.dlshouwen.grid.tools.dateFormat(new Date(Math
				.floor(Math.random() * 1096588800000) + 315504000000),
				'yyyy-MM-dd hh:mm:ss');
		datas.push(user);
	}
			...
			<div class="layout main-container">
				...
				<script type="text/javascript">
					...
					var gridOption_2_1_2 = {
						...
						tools : 'print|export[excel,csv,pdf,txt]|fastQuery|advanceQuery',
						pageSize : 10,
				...
				<div id="gridToolBarContainer_2_1_2"
